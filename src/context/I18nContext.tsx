...
const translations: Translations = {
  es: {
    ...
    mlPricePredictor: 'Predicción de Precios',
    ...
    sortRatingDesc: 'Mejor Puntuado',
    sortReviewsDesc: 'Más Reseñado',
    sortDiscountDesc: 'Mayor Descuento',
    groupByLabel: 'Agrupar por',
    groupByNone: 'Sin agrupar',
    groupBySource: 'Tienda / Fuente',
    sourceLabel: 'Tienda / Fuente',
    sourceAll: 'Todas las tiendas',
    minRatingLabel: 'Calificación mínima',
    deliveryLabel: 'Envío',
    deliveryAny: 'Cualquiera',
    deliveryFree: 'Gratis',
    deliveryPaid: 'No gratis',
  ...
  en: {
    ...
    mlPricePredictor: 'Price Prediction',
    ...
    sortReviewsDesc: 'Most Reviewed',
    sortDiscountDesc: 'Biggest Discount',
    groupByLabel: 'Group by',
    groupByNone: 'None',
    groupBySource: 'Store / Source',
